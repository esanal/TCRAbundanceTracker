...
from tcr_app.page_organ_distribution import run_organ_distribution_page
...
def main() -> None:
    ...
    elif page == "Clonotype Organ Spread":
        run_organ_distribution_page(df)
